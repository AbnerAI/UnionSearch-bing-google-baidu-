...
<html>
	...
	<body style="background-color:#3B83C0">
			<div style="margin-top:0px;margin-left:0px">
				<form method="get" action="scholarmainsearch.php" target="blank" id="myform">
					<div style="margin-top:0px;width:500px;margin:auto">
					<b><font color="white">综合搜索</font></b><input type="text" name="input"  value="'.$input_.'" id="input" style="width: 400px;height: 25px;font-size: 20px;" />
